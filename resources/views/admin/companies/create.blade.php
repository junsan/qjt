                            ...
                            <div class="col-md-6">
                                <form action="{{route('companies.store')}}" method="POST">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input name="name" class="form-control" id="inputName" type="text" placeholder="Company Name" />
                                        <label for="inputName">Company Name</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input name="address" class="form-control" id="inputAddess" type="text" placeholder="Address" />
                                        <label for="inputAddess">Address</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input name="website" class="form-control" id="inputWebsite" type="text" placeholder="Website" />
